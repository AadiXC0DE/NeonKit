...
export default function SliderSizesPreview() {
  const [smValue, setSmValue] = React.useState([40]);
  const [defaultValue, setDefaultValue] = React.useState([60]);
  const [lgValue, setLgValue] = React.useState([80]);
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-slate-400">{smValue[0]}%</span>
          </div>
          <Slider
            value={smValue}
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm text-slate-400">{defaultValue[0]}%</span>
          </div>
          <Slider
            value={defaultValue}
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm text-slate-400">{lgValue[0]}%</span>
          </div>
          <Slider
            value={lgValue}
