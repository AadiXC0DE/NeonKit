...
export default function NeonSlidersPreview() {
  const [cyanValue, setCyanValue] = React.useState([65]);
  const [purpleValue, setPurpleValue] = React.useState([45]);
  const [chartreuseValue, setChartreuseValue] = React.useState([80]);
  const [pinkValue, setPinkValue] = React.useState([35]);
  ...
  return (
    <div className="space-y-8 w-full max-w-lg">
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <label className="text-sm font-medium text-cyan-400 flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-cyan-400 shadow-[0_0_8px_rgb(34,211,238,0.8)]"></div>
              Neon Cyan
            </label>
            <span className="text-sm text-cyan-300">{cyanValue[0]}%</span>
          </div>
          <Slider
            value={cyanValue}
            onValueChange={setCyanValue}
            variant="neon-cyan"
            size="lg"
            showValue
            className="w-full"
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <label className="text-sm font-medium text-purple-400 flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-purple-400 shadow-[0_0_8px_rgb(168,85,247,0.8)]"></div>
              Neon Purple
            </label>
            <span className="text-sm text-purple-300">{purpleValue[0]}%</span>
          </div>
          <Slider
            value={purpleValue}
            onValueChange={setPurpleValue}
            variant="neon-purple"
            showValue
            className="w-full"
          />
        ...
        {/* Neon Chartreuse Slider */}
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <label className="text-sm font-medium text-lime-400 flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-lime-400 shadow-[0_0_8px_rgb(163,230,53,0.8)]"></div>
              Neon Chartreuse
            </label>
            <span className="text-sm text-lime-300">{chartreuseValue[0]}%</span>
          </div>
          <Slider
            value={chartreuseValue}
            onValueChange={setChartreuseValue}
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <label className="text-sm font-medium text-pink-400 flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-pink-400 shadow-[0_0_8px_rgb(244,114,182,0.8)]"></div>
              Neon Pink
            </label>
            <span className="text-sm text-pink-300">{pinkValue[0]}%</span>
          </div>
          <Slider
            value={pinkValue}
            onValueChange={setPinkValue}
            variant="neon-pink"
            size="sm"
            showValue
            className="w-full"
