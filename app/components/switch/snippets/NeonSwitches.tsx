...
const Switch = React.forwardRef<HTMLButtonElement, SwitchProps>(
  (
    ...
    const variants = {
      ...
      "neon-red": {
        track: "bg-slate-700 border border-red-400/30",
        trackChecked:
          "bg-red-400/20 border-red-400 shadow-[0_0_10px_rgb(248,113,113,0.3)]",
        thumb: "bg-slate-400",
        thumbChecked: "bg-red-400 shadow-[0_0_8px_rgb(248,113,113,0.6)]",
      },
      "neon-emerald": {
        track: "bg-slate-700 border border-emerald-400/30",
        trackChecked:
          "bg-emerald-400/20 border-emerald-400 shadow-[0_0_10px_rgb(52,211,153,0.3)]",
        thumb: "bg-slate-400",
        thumbChecked: "bg-emerald-400 shadow-[0_0_8px_rgb(52,211,153,0.6)]",
      },
      "neon-amber": {
        track: "bg-slate-700 border border-amber-400/30",
        trackChecked:
          "bg-amber-400/20 border-amber-400 shadow-[0_0_10px_rgb(251,191,36,0.3)]",
        thumb: "bg-slate-400",
        thumbChecked: "bg-amber-400 shadow-[0_0_8px_rgb(251,191,36,0.6)]",
      },
    };
    ...
    const thumbContent = (
      <motion.div
        ...
        animate={{
          x: isChecked ? (size === "sm" ? 12 : size === "lg" ? 24 : 18) : 2,
        }}
...
export default function NeonSwitchesPreview() {
  return (
    <div className="space-y-8 w-full max-w-md">
      <div className="space-y-6">
        <div className="space-y-4">
          <h4 className="text-sm font-medium text-muted-foreground">
            Neon Switch Variants:
          </h4>

          <div className="grid grid-cols-2 gap-4">
            <Switch variant="neon-cyan" defaultChecked />
            <Switch variant="neon-purple" defaultChecked />
            <Switch variant="neon-chartreuse" defaultChecked />
            <Switch variant="neon-pink" defaultChecked />
            <Switch variant="neon-red" defaultChecked />
            <Switch variant="neon-emerald" defaultChecked />
            <Switch variant="neon-amber" defaultChecked />
          </div>
        </div>
      </div>
    </div>
