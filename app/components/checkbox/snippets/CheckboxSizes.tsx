        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              <Checkbox size="sm" variant="neon-cyan" />
              <Checkbox size="sm" variant="neon-purple" defaultChecked />
              <Checkbox size="sm" variant="neon-chartreuse" />
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              <Checkbox variant="neon-cyan" />
              <Checkbox variant="neon-purple" defaultChecked />
              <Checkbox variant="neon-chartreuse" />
              <span className="text-xs text-muted-foreground">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              <Checkbox size="lg" variant="neon-cyan" />
              <Checkbox size="lg" variant="neon-purple" defaultChecked />
              <Checkbox size="lg" variant="neon-chartreuse" />
              <span className="text-xs text-muted-foreground">
