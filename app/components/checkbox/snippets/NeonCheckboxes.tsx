...
export default function NeonCheckboxesPreview() {
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-3">
              <Checkbox
                checked={features.neonGlow}
                onCheckedChange={() => updateFeature("neonGlow")}
                variant="neon-cyan"
              />
              <label className="text-sm font-medium">Neon Glow Effects</label>
            ...
            <div className="flex items-center space-x-3">
              <Checkbox
                ...
                onCheckedChange={() => updateFeature("darkMode")}
                variant="neon-purple"
              />
            ...
            <div className="flex items-center space-x-3">
              <Checkbox
                ...
                onCheckedChange={() => updateFeature("animations")}
                variant="neon-chartreuse"
              />
              <label className="text-sm font-medium">Smooth Animations</label>
              <span className="text-xs text-muted-foreground">(Fluid)</span>
            </div>

            <div className="flex items-center space-x-3">
              <Checkbox
                checked={features.soundEffects}
                onCheckedChange={() => updateFeature("soundEffects")}
                variant="neon-pink"
              />
