...
export default function NeonAvatarsPreview() {
  return (
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Neon Cyan Glow</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Neon Purple Glow</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          <Avatar fallback="SM" variant="neon-pink" />
          <div>
            <p className="font-medium">Sarah Miller</p>
            <p className="text-sm text-muted-foreground">Neon Pink Glow</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="flex -space-x-2">
          <Avatar
            ...
            variant="neon-cyan"
          />
          <Avatar fallback="SM" variant="neon-purple" />
          <Avatar
            src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop&crop=face"
            variant="neon-chartreuse"
          />
          <Avatar fallback="AC" variant="neon-pink" />
        </div>
      </div>
    </div>
  );
