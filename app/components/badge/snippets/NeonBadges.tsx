...
export default function NeonBadgesPreview() {
  return (
    <div className="space-y-6 w-full max-w-md">
      <div className="space-y-4">
        <div className="flex flex-wrap gap-3">
          <Badge variant="neon-cyan">Cyan Glow</Badge>
          <Badge variant="neon-purple">Purple Glow</Badge>
          <Badge variant="neon-chartreuse">Chartreuse Glow</Badge>
        </div>

        <div className="flex flex-wrap gap-3">
          <Badge variant="neon-pink">Pink Glow</Badge>
          <Badge variant="neon-destructive">Destructive Glow</Badge>
          <Badge variant="neon-success">Success Glow</Badge>
        </div>

        <div className="flex flex-wrap gap-3">
          <Badge variant="neon-warning">Warning Glow</Badge>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          <Badge variant="neon-success">Online</Badge>
          <Badge variant="neon-warning">Away</Badge>
          <Badge variant="neon-destructive">Offline</Badge>
          <Badge variant="neon-cyan">New Message</Badge>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          <Badge variant="neon-destructive">High Priority</Badge>
          <Badge variant="neon-warning">Medium Priority</Badge>
          <Badge variant="neon-success">Low Priority</Badge>
        </div>
      </div>
    </div>
  );
