...
export default function RemovableBadgesPreview() {
  ...
  const [filters, setFilters] = React.useState(["New", "Featured", "Popular"]);
  ...
  return (
    <div className="space-y-8 w-full max-w-lg">
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          <Badge variant="neon-success" removable>
            Task Completed
          </Badge>
          <Badge variant="neon-warning" removable>
            In Progress
          </Badge>
          <Badge variant="neon-destructive" removable>
            Blocked
          </Badge>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          <Badge variant="neon-destructive" size="sm" removable>
            Urgent
          </Badge>
          <Badge variant="neon-warning" size="sm" removable>
            High
          </Badge>
          <Badge variant="neon-success" size="sm" removable>
            Normal
          </Badge>
        </div>
      </div>
