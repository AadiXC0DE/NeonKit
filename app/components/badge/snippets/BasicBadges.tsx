...
export default function BasicBadgesPreview() {
  ...
  return (
    <div className="space-y-6 w-full max-w-md">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Badge variant="neon-success">Success</Badge>
        <Badge variant="neon-warning">Warning</Badge>
        <Badge variant="neon-destructive">Error</Badge>
      </div>
