...
export default function NeonTooltipsPreview() {
  return (
    <div className="space-y-8 w-full max-w-lg">
      <div className="space-y-6">
        <div className="space-y-4">
          <h4 className="text-sm font-medium text-muted-foreground">
            Neon Tooltip Examples:
          </h4>

          <div className="flex flex-wrap gap-4">
            <Tooltip
              content="This is a cyan glow tooltip with electric effects"
              variant="neon-cyan"
            >
            ...
            <Tooltip
              content="Purple neon tooltip with stunning visual effects"
              variant="neon-purple"
            >
            ...
            <Tooltip
              content="Chartreuse glow for that retro gaming vibe"
            ...
            <Tooltip
              content="Pink neon for a softer, more elegant glow"
              variant="neon-pink"
            >
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-4">
            <Tooltip
              content="Click to save your neon settings"
              variant="neon-cyan"
            >
              <button className="p-3 bg-slate-800 border border-cyan-400/60 text-cyan-400 rounded hover:bg-cyan-400/10 transition-all duration-300">
                💾
              </button>
            </Tooltip>

            <Tooltip
              content="Adjust neon brightness levels"
              variant="neon-purple"
            >
              <button className="p-3 bg-slate-800 border border-purple-400/60 text-purple-400 rounded hover:bg-purple-400/10 transition-all duration-300">
                🔆
              </button>
            </Tooltip>

            <Tooltip
              content="Toggle neon animation effects"
              variant="neon-chartreuse"
            >
              <button className="p-3 bg-slate-800 border border-purple-400/60 text-purple-400 rounded hover:bg-purple-400/10 transition-all duration-300">
                ✨
