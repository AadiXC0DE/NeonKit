...
const componentCategories = [
  ...
  },
  {
    ...
    items: [
      { name: "Card", href: "/components/card", description: "Content containers" },
      { name: "Container", href: "/components/container", description: "Layout containers", disabled: true },
    ]
  },
  {
    title: "Feedback Components", 
    items: [
      { name: "Alert", href: "/components/alert", description: "Alert messages", disabled: true },
      { name: "Toast", href: "/components/toast", description: "Notification toasts", disabled: true },
    ]
  }
]
            ...
            >
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <div className={cn(
                    "text-xs",
                    pathname === "/setup" ? "text-neon-cyan/70" : "text-muted-foreground"
                  )}>
                ...
                <ChevronRight className={cn(
                  ...
                  pathname === "/setup" ? "rotate-90" : "group-hover:translate-x-1"
                )} />
              </Link>
            </motion.div>
          </div>
          ...
          <div className="space-y-1">
             ...
             >
               <div className="flex-1 min-w-0">
                 ...
                 <div className="text-xs text-muted-foreground">Custom colors guide</div>
               </div>
             </Link>
             <Link 
             ...
             >
               <div className="flex-1 min-w-0">
                 ...
                 <div className="text-xs text-muted-foreground">Component combinations</div>
               </div>
             </Link>
           </div>
        </div>
