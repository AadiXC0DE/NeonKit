...
const Checkbox = React.forwardRef<HTMLButtonElement, CheckboxProps>(
  (
    ...
    const variants = {
      ...
      "neon-cyan": {
        box: "border-slate-600 hover:border-cyan-400/60 bg-transparent",
        boxChecked:
          "border-cyan-400 bg-cyan-400 shadow-[0_0_10px_rgb(34,211,238,0.4)]",
        check: "text-white",
      },
      "neon-purple": {
        box: "border-slate-600 hover:border-purple-400/60 bg-transparent",
        boxChecked:
          "border-purple-400 bg-purple-400 shadow-[0_0_10px_rgb(168,85,247,0.4)]",
        check: "text-white",
      },
      "neon-chartreuse": {
        box: "border-slate-600 hover:border-lime-400/60 bg-transparent",
        boxChecked:
          "border-lime-400 bg-lime-400 shadow-[0_0_10px_rgb(163,230,53,0.4)]",
        check: "text-white",
      },
      "neon-pink": {
        box: "border-slate-600 hover:border-pink-400/60 bg-transparent",
        boxChecked:
